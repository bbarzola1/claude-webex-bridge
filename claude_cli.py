...
async def _run_cli(
    cmd: list[str],
    cwd: str,
    on_process_started: Optional[Callable[[asyncio.subprocess.Process], None]] = None,
) -> str:
    """Run a claude CLI command and return the output text."""
    try:
...
async def send_message(
    ...
    return await _run_cli(cmd, cwd, on_process_started)
